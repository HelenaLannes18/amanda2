import { HStack, Input, InputGroup, InputLeftElement, Link } from "@chakra-ui/react"
import NextLink from 'next/link'

import { ButtonActions, ButtonAd } from "../../components/Button"
        ...
        <Main title2={"Painel Administrativo PDF"} title="" w={undefined} path={""} altText={""} tamh={0} tamw={0}>
            ...
            >
                <Stack
                    align={"end"}
                >
                    <ButtonAd text={"Gerar Novo PDF"} mt={"10%"} />
                </Stack>
                ...
                <ButtonPage text={"Gerar Novo PDF"} href="/painel-pdf/gerador-pdf" w={{ xl: "23%", lg: "27%" }} mt={{ xl: "10%", lg: "14%", md: "3%", xxs: "5%" }} />
            </Stack>
