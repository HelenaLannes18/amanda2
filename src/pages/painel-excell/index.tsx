import { Stack, Table, TableContainer, Tbody, Td, Th, Thead, Tr, Link, HStack, Input, InputGroup, InputLeftElement } from "@chakra-ui/react"
        ...
        <Main title2={"Painel Administrativo Excell"} title="" w={undefined} path={""} altText={""} tamh={0} tamw={0}>
            ...
            >
                <Stack
                    align={"end"}
                >
                    <ButtonAd text={"Gerar Nova Planilha"} mt={"10%"} />
                </Stack>
                ...
                <ButtonPage text={"Gerar Nova Planilha"} href="/painel-excell/gerador-excell" w={{ xl: "23%", lg: "27%" }} mt={{ xl: "10%", md: "14%", xxs: "10%" }} />
            </Stack>
            <CardCadastro />
        </Main>
    )
